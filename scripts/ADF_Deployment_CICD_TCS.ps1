...
{
    # ResourceGroup exist
	New-AzResourceGroupDeployment -Debug -Verbose -Name $DeploymentName -ResourceGroupName $ResourceGroupName -TemplateFile $armTemplateJSON -TemplateParameterFile $armParameterJSON
}